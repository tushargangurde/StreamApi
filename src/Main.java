...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Optional<Double> sal = employeeList.stream()
                .map(e -> e.getSalary())
        ...
        employeeList.stream()
                .filter(e -> e.getSalary() > 20000 && e.getName().startsWith("M"))
        ...
        Map<String, Long> out = input.chars()
                .mapToObj(e -> (char) e)
        ...
        System.out.println("Find the no of occurrences int the String");
